            ...
            <div className="container mx-auto pt-7">
                <div className="max-w-sm w-full lg:max-w-full lg:flex">
                    <div className="bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
                        <div className="grid grid-cols-4 md:grid-cols-4 mt-7" key={id}>
                            <Link to={`/product/${ id }`}>
                                <div className="max-w-sm border border-gray-200 block rounded-lg shadow">
                                    <div className='p-3'>
                                        <img className="h-56 w-56 rounded-lg" src={image} alt={title} />
